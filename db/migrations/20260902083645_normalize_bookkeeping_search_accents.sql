-- Bank statement labels are multilingual and may contain accented characters.
-- Normalize common Latin accents before deterministic matching so labels such as
-- "Remb. paiement électronique" are reliably recognized as refunds.
