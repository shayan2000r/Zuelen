-- Luxembourg PCN2020 hierarchy reference.
-- Canonical production hierarchy was verified against the official eCDF standard mapping,
-- financial year 2026:
...
comment on table public.pcn_account_groups is
  'Luxembourg PCN grouping hierarchy. Posting accounts remain in pcn_accounts.';
