...
import { createSourceTransaction, initialTransactionState } from "@/app/app/transactions/actions";
  ...
  return (
    <aside className={styles.formPanel}>
      ...
      <form action={formAction} className={styles.transactionForm}>
        ...
        <label className={`${styles.field} ${styles.fieldFull}`}><span>Customer / supplier</span><input name="counterparty_name" placeholder="e.g. Adobe Ireland" /></label>
