    ...
    try {
      ...
      if (mode === "signin") {
        ...
        if (data.session) {
          ...
          setMessage(destination?"Check your inbox to confirm your email. The confirmation link will return you to your invitation.":"Check your inbox to confirm your email. The confirmation link will return you to Compta setup.");
        }
      }
    } catch (error) {
