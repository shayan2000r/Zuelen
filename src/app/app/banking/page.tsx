...
export default async function BankingPage({searchParams}:{searchParams:SearchParams}){
  ...
  return <div className={styles.page}>
    <div className={styles.intro}><div><p>Cash → books</p><h1>Banking</h1><span>Import statements, reconcile movements and keep cash aligned with the ledger.</span></div><div className={styles.health}><CheckCircle2 size={14}/>{coverage}% reconciled</div></div>
