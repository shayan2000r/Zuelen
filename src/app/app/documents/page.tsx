...
export default async function DocumentsPage() {
  ...
  const { data, error } = await supabase.from("documents").select("id,type,file_name,mime_type,file_size,extraction_status,created_at,storage_path").eq("company_id",workspace.company.id).order("created_at",{ascending:false}).limit(150);
