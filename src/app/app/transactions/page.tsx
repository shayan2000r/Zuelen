...
export default async function TransactionsPage({searchParams}:{searchParams:SearchParams}){
 ...
 return <div className={styles.page}>
  <div className={styles.intro}><div><p>Bookkeeping source · FY {year}</p><h1>Transactions</h1><h2>Review, classify and manage {year} activity without losing the audit trail.</h2></div><span className={styles.badge}><b>{pendingRows.length}</b> to review · {rows.length} active</span></div>
